  ...
  <div class="px-5">
    <div class="w-full max-w-[1260px] flex flex-col gap-5 lg:gap-12 m-auto py-10">
      <div class="text-sm lg:text-xl">
        ...
        <span> > </span>
        <Link class="hover:underline">機場服務</Link>
        <span> > </span>
        <Link class="hover:underline">遺失物查詢</Link>
      </div>
      <mainTitle>
      ...
      <div class="bg-white text-sm lg:text-2xl p-5 lg:p-10 white rounded-[20px]">
        ...
        <p>
          ...
          <Link class="text-[#471C87]">https://op2.npa.gov.tw/NM107-512Client/OP010A10_Q1.jsp</Link>
        </p>
        <p>財政部關務署臺中關聯絡電話：(04)-26155172</p>
        <p>
          財政部關務署臺中關網址為：
          <Link class="text-[#471C87]">https://taichung.customs.gov.tw</Link>
        </p>
      </div>
